...
const TopSellingItems = () => {
    ...
    return (
      <div className="bg-white hover:scale-105 hover:duration-500 hover:ease-in-out cursor-pointer p-2  min-w-[200px] rounded-xl shadow-[0px_1px_7.2px_-2px_rgba(0,_0,_0,_0.25)] mr-8">
        <img src={img1} alt="" />
