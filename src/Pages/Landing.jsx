    ...
    <div className="flex flex-col">
      <div className="px-4">
        <div className="relative">
          <img src={corn} alt=""  className="absolute -right-[1rem] top-[24rem] "/>
          <img src={onion} alt=""  className="absolute top-[26.4rem] left-12"/>
          <div className="  bg-[#FFE6AE]   w-full   mt-2 rounded-[15px] ">
            <img
              src={texture}
              alt=""
              className=" rounded-[15px]  min-h-[714px]   mix-blend-plus-lighter  object-cover "
            />
          </div>
          ...
          <div className="absolute -bottom-[14rem] mx-auto left-1/2  transform  -translate-x-1/2 px-[8rem] w-full">
            {" "}
            <img
              src={heroimg}
              alt=""
