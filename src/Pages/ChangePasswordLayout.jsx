...
const ChangePasswordLayout = () => {
  return (
    <div className="min-h-screen w-full bg-[#F5F5F5] ">
      ...
      <div className="absolute w-full flex items-center justify-center px-4  flex-wrap lg:justify-center gap-6  bottom-0 py-4 bg-[#006924] text-[#FCE5CD] font-manrope font-semibold text-[12px] md:text-[14px]">
